    ...
    const employees = await Employee.bulkCreate([
      {
        ...
        services: [
          { name: "חיווט חדש", minPrice: 300, maxPrice: 800 },
          { name: "תיקון ממסרים", minPrice: 150, maxPrice: 400 },
          { name: "התקנת נורות LED", minPrice: 200, maxPrice: 500 },
          { name: "בדיקת בטיחות", minPrice: 250, maxPrice: 600 },
        ],
      ...
      },
      {
        ...
        services: [
          { name: "ציפוי רהיטים", minPrice: 500, maxPrice: 2000 },
          { name: "תיקון עץ", minPrice: 200, maxPrice: 800 },
          { name: "עיצוב מחדש", minPrice: 800, maxPrice: 3000 },
          { name: "ייצור ספסלים", minPrice: 1200, maxPrice: 4000 },
        ],
      ...
      },
      {
        ...
        services: [
          { name: "טיפול בעור", minPrice: 180, maxPrice: 350 },
          { name: "מניקור", minPrice: 80, maxPrice: 150 },
          { name: "פדיקור", minPrice: 100, maxPrice: 180 },
          { name: "ספא ביתי", minPrice: 300, maxPrice: 600 },
        ],
      ...
      },
      {
        ...
        services: [
          { name: "ניקיון עמוק", minPrice: 400, maxPrice: 900 },
          { name: "ניקיון חלונות", minPrice: 150, maxPrice: 400 },
          { name: "ניקיון שטיחים", minPrice: 200, maxPrice: 500 },
          { name: "ניקיון לאחר בנייה", minPrice: 600, maxPrice: 1500 },
        ],
      ...
      },
      {
        ...
        services: [
          { name: "עוגות יום הולדת", minPrice: 350, maxPrice: 900 },
          { name: "עוגות קישוט", minPrice: 400, maxPrice: 1200 },
          { name: "קאפקייקס מעוצבות", minPrice: 120, maxPrice: 300 },
          { name: "עוגיות", minPrice: 80, maxPrice: 200 },
        ],
      ...
      },
      {
        ...
        services: [
          { name: "הסעה יומית", minPrice: 100, maxPrice: 250 },
          { name: "אילוף כלבים", minPrice: 200, maxPrice: 500 },
          { name: "טיפול יומי", minPrice: 150, maxPrice: 350 },
          { name: "טיפול וטיפוח", minPrice: 120, maxPrice: 280 },
        ],
